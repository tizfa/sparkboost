 ...
 */
public class BoostClassifierBenchRamExe {
    public static void main(String[] args) {
        ...
        try {
            ...
            formatter.printHelp(BoostClassifierBenchRamExe.class.getSimpleName() + " [OPTIONS] <inputFile> <inputModel> <outputFile>", options);
            System.exit(-1);
        }
        ...
        List<MultilabelPoint> docsList = DataUtils.loadLibSvmFileFormatDataWithIDs(sc, inputFile, labels0Based, binaryProblem, parallelismDegree).collect();
        Logging.l().info("done.");
        JavaRDD<MultilabelPoint> docs = sc.parallelize(docsList);
